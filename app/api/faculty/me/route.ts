...
export async function GET() {
  ...
  const faculty = await prisma.portalFaculty.findUnique({
    ...
    select: { id: true, fullName: true, username: true, workEmail: true, phone: true, designation: true, department: true, collegeName: true, profilePhotoUrl: true, bio: true, status: true, lastLoginAt: true, createdAt: true },
  });
